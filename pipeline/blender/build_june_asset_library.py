...
def main() -> None:
    ...
    studio._clear(bpy)
    materials = studio._make_materials(bpy)
    studio._make_porch(bpy, mathutils, materials, 390)
    rig, mouth, eyes = studio._make_june(bpy, mathutils, materials)
    ...
    studio._animate_expressions(bpy.data.objects["June_Head"], library_plan)
    studio._animate_blinks(eyes, 390)
