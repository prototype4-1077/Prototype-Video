...
- Evidence: "Only 69 of 2614 scene records have a human decision (2.6%)."
...
- Evidence: {"count": 73, "examples": ["a-chair-not-a-throne", "awake-inside-the-dream", "belief-is-gravity", "beliefs-are-software-updates", "can-you-fly", "can-you-fly-v3", "deepest-sleep", "dispatch-path-selftest", "dmt-customs", "dmt-loading-screen", "dmt-other-side-of-the-door", "dmt-the-understudy", "futures-fingerprints", "how-you-doing", "i-was-gone-eleven-minutes"]}
...
- Evidence: {"coverage": 0.1364, "feedback_count": 3, "feedback_slugs": ["belief-is-gravity", "no-disagreement-here", "the-edge-of-you-is-negotiable"], "reviewable_count": 22, "reviewable_slugs": ["a-chair-not-a-throne", "belief-is-gravity", "beliefs-are-software-updates", "dispatch-path-selftest", "i-was-gone-eleven-minutes", "june-oxley-left-the-vehicle", "no-disagreement-here", "the-adjacent-mind", "the-blueprint-recognizes-the-building", "the-edge-of-you-is-negotiable", "the-emotion-scam-tier1", "the-infinite-library", "the-mercy-of-the-filter", "the-reality-machine-dmt-v3", "the-room-has-more-than-one-window", "the-universe-keeps-its-options-open", "the-witness-without-a-face", "tomorrow-uses-old-footage", "who-wrote-the-menu", "wonder-is-a-glitch", "your-emergency-contact", "your-inner-bodyguard"]}
...
- Evidence: "Only 127 of 2614 records retain a reviewable asset (4.9%)."
...
### [MEDIUM] Low Approval Cohort
- Area: `visual_memory`
- Code: `visual:low_approval_cohort:provider:unknown`
- Evidence: "0/13 approved (0%)"
- Action: Inspect the cohort before changing global routing; topic and scene difficulty may be confounders.
...
- Evidence: {"exclusions": {"banned_ids": 113, "used_ids": 1031}, "fallback_rate": 0.0401, "low_supply_rate": 0.0219, "measurement_boundary": "Candidate decisions reflect narrative-fidelity reranking after search. This report cannot reconstruct every raw API result or prove that exclusions caused a missing candidate.", "reports_analyzed": 15, "scenes_analyzed": 274, "state": "no_current_starvation_signal"}
